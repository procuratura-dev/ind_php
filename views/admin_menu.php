...
?>
<!-- event edit -->
<form action="../views/admin_menu.php" method="POST" enctype="multipart/form-data">
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['userEmail']) && isset($_POST['roleUser'])) {
    ...
    if ($stmt->execute([$role_id, $user_email])) {
        header("Location: ../public/index.php"); // Перенаправление обратно на страницу с событиями
        exit;
    }
}
